...
import { X, HardDrive, FileArchive, Download, Gamepad2 } from "lucide-react";
      ...
      >
        ...
        <div className="flex items-start justify-between p-5 pb-0">
          <div>
            ...
            <span className="text-xs text-neutral-400 font-mono">.zip</span>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 text-sm">
              ...
              <span className="text-neutral-800 font-mono text-xs">{game.size}</span>
            </div>
            <div className="flex items-center gap-3 text-sm">
              <FileArchive size={14} className="text-neutral-400 shrink-0" />
              <span className="text-neutral-500 w-28 shrink-0">Datei</span>
              <span className="text-neutral-800 font-mono text-xs truncate">
                {game.fileName.replace("g/", "")}
              </span>
            </div>
          </div>
